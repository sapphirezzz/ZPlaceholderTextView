...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/ZPlaceholderTextView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sapphirezzz' => 'zhengzuanzhe@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/ZPlaceholderTextView.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'ZPlaceholderTextView' => ['ZPlaceholderTextView/Assets/*.png']
  # }
